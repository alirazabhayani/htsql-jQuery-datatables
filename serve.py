# Following file is downloaded from https://bitbucket.org/prometheus/htsql/src/84a6f07ddc94/demo/htraf/serve.py
# Changes made in the original file are kept and commented
...
class Application(object):
    ...
    def __call__(self, environ, start_response):
        ...
        #    or path[len(root):].startswith('/examples10'):
        if not (path == root or path.startswith(root+os.path.sep)):
